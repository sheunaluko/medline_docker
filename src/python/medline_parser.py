## FORKED FROM = https://github.com/titipata/pubmed_parser/blob/master/pubmed_parser/medline_parser.py
...
from pubmed_parser_utils import read_xml, stringify_children, month_or_day_formater
...
def parse_mesh_terms(medline):
    ...
    if medline.find("MeshHeadingList") is not None:
        ...
        mesh_terms = [ x.split(":")[0] for x in mesh_terms_list ]  # simple modification 
    else:
        mesh_terms = None
    return mesh_terms
